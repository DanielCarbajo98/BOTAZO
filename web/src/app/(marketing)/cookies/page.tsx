...
export default function CookiesPage() {
  return (
    <LegalLayout title="Política de cookies" updated="pendiente de publicación">
      ...
      <ul>
        <li>
          <strong>Borrador del formulario</strong> (<code>vl-wizard-v1</code>, almacenamiento local del navegador):
        ...
        <li>
          <strong>Aviso de cookies</strong> (<code>vl-cookies-v1</code>, almacenamiento local): recuerda que ya has
          visto este aviso.
        </li>
        <li>
          <strong>Sesión del área de gestión</strong> (<code>vl_session</code>, cookie): solo se crea si eres parte
