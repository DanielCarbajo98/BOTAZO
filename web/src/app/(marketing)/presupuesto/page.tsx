...
export const metadata: Metadata = {
  ...
  description:
    'Cuéntanos tu viaje en 3 minutos y te enviamos un presupuesto con tres opciones y el desglose completo. Gratis y sin compromiso.',
    ...
    <>
      <section className="border-b border-ink-100 bg-white py-10">
        <div className="container-page">
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-brand-700">Presupuesto gratis</p>
          <h1 className="sr-only">Pedir presupuesto</h1>
